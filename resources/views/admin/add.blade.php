        ...
        <form action="/insert" method="POST" enctype="multipart/form-data" class="space-y-4">
          @csrf
            ...
            <div>
                ...
                <input value="{{ old('judul') }}" type="text" id="judul" name="judul"
            ...
            <div>
                ...
                <textarea  id="deskripsi" name="deskripsi" rows="4"
                    class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    placeholder="Tulis deskripsi buku" required>{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <p class="text-sm font-sm text-red-700">
                          *{{ $message }}
                        </p>
            ...
            <div>
                ...
                <input value="{{ old('penulis') }}" type="text" id="penulis" name="penulis"
                    class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            ...
            <div>
                ...
                <input value="{{ old('harga') }}" type="number" id="harga" name="harga"
                    class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            ...
            <div>
                ...
                <input value="{{ old('tahun') }}" type="number" id="tahun_terbit" name="tahun"
                    class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            ...
            <div class="dropdown">
                ...
                <input value="{{ old('kategori') }}" type="text" id="kategori" name="kategori"
                    class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            ...
            <div class="flex justify-between">
                ...
                <button type="submit"
                    class="px-6 py-2 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-300 transition">Tambah
                    Buku</button>
            </div>
        </form>
    </div>
